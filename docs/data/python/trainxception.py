...
model = applications.Xception(weights='imagenet', include_top = False, input_tensor = input)
...
tfjs.converters.save_keras_model(model, '../cifar10/xception')
model.save('../cifar10/xception/xception.h5')